...
from .person_standard_roi_head import Person_StandardRoIHead
from .triage_standard_roi_head import Triage_StandardRoIHead
...
__all__ = [
    ...
    'Person_StandardRoIHead', 'Triage_StandardRoIHead'
]
